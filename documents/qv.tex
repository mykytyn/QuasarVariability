...
This marginalization (to remove all explicit mention of the implicit
...
$\sigma^2\,\delta{nn'}$ added only to the diagonal elements to model
the measurement noise variance.  This model is very rigid, in that the
